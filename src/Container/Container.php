...
use Closure;
use Exception;
use Imhotep\Container\Traits\Callbacks;
use Imhotep\Container\Traits\Reflection;
...
class Container implements ArrayAccess, ContainerInterface
{
    ...
    // Aliases
    public function alias(string $alias, Closure|string $abstract): void
    {
        if ($alias == $abstract) {
    ...
    */
    ...
    protected function addContainerCallback(string $event, string|Closure $abstract, Closure $callback): void
    {
        if (is_string($abstract)) {
            $abstract = $this->getAlias($abstract);
        }
